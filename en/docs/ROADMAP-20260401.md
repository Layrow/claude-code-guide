# Roadmap: claude-code-guide 2026–2027
...
Transform claude-code-guide from a static tutorial repo into a **living, dual-audience knowledge system**:
...
- `skills/claude-code-guide-lookup/SKILL.md` — lightweight agent skill that queries the manifest
