...
**[15 分钟开始上手](#15-分钟快速开始)** | **[先判断你的级别](#不知道从哪里开始)** | **[浏览功能目录](CATALOG_zh.md)**
...
先做 [self-assessment quiz](LEARNING-ROADMAP_zh.md)，或者直接在 Claude Code 中运行 `/self-assessment`。你会根据已有基础拿到一条个性化路线图。
...
**[开始学习路径 ->](LEARNING-ROADMAP_zh.md)** | **[浏览功能目录](CATALOG_zh.md)** | **[15 分钟开始上手](#15-分钟快速开始)**
