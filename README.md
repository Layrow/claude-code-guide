...
Shared tooling and repository infrastructure remain at the repository root:
...
```text
.
├── en/         # English docs and examples
├── zh/         # Chinese docs and examples
├── scripts/    # Validation and EPUB tooling
├── .github/    # CI and collaboration templates
├── .claude/    # Local skill examples
