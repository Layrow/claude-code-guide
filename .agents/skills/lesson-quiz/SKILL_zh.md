...
name: lesson-quiz
version: 1.0.0
description: 面向 Codex 教程的互动式单课测验。围绕某一节课程（01-10）用 8-10 道题混合考察概念理解与实操能力。可在学习前做预检、学习中检查进度、学习后验证掌握度。适用于用户说出 “quiz me on hooks”、“test my knowledge of lesson 3”、“lesson quiz”、“practice quiz for MCP” 或 “do I understand skills” 这类请求时。
---

# Lesson Quiz

这是一个交互式测验，用 8-10 道题测试你对某一节 Codex 课程的理解，提供逐题反馈，并指出需要回看的地方。
...
2. "Memory (02)" — AGENTS.md、记忆层级、规则、自动记忆
